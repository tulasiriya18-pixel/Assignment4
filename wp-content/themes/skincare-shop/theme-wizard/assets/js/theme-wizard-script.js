var Whizzie = (function($) {
  ...
  function PluginManager() {
        ...
        if (typeof response.url != 'undefined') {
          ...
          if (response.hash == current_item_hash) {
            ...
            jQuery.post(response.url, response, function(response2) {
              process_current();
              $current_node.find('span').text(response.message + skincare_shop_whizzie_params.verify_text);
            }).fail(ajax_callback);
          }
    ...
    function process_current() {
      if (current_item) {
        ...
        jQuery.post(skincare_shop_whizzie_params.ajaxurl, {
          action: 'setup_plugins',
          wpnonce: skincare_shop_whizzie_params.wpnonce,
          slug: current_item
  ...
  function WidgetManager() {
    function import_widgets() {
      jQuery.post(
        skincare_shop_whizzie_params.ajaxurl, {
...
jQuery(document).ready(function ($) {
    $('.ti-setup-menu').show();
    $('.ti-setup-widget').hide();
    $('#ti-prev').hide();

    $('#ti-next').on('click', function () {
        $('#ti-setup-widget').prop('checked', true);

        $('.ti-setup-menu').hide();
        $('.ti-setup-widget').show();
    ...
    $('#ti-prev').on('click', function () {
        $('#ti-setup-menu').prop('checked', true);
