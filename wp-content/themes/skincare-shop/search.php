            ...
            <div class="row">
                <?php if (get_theme_mod('skincare_shop_post_layout_setting', 'right-sidebar') == 'one-column') { ?>              
                    <?php if ( have_posts() ) : ?>
                        ...
                        <header class="page-header">
                            <h1 class="page-title">
                                <?php printf( esc_html__( 'Search Results', 'skincare-shop' ) ); ?>
                            </h1>
                            ...
                            <p class="count">
                                <?php
                                printf(
                                    esc_html__( 'Search Results for "%s"', 'skincare-shop' ),
                ...
                <?php } elseif (get_theme_mod('skincare_shop_post_layout_setting', 'right-sidebar') == 'grid-layout') { ?>
                    <div class="row">
                        <?php if (have_posts()) : ?>
                            <header class="page-header">
                                <h1 class="page-title"><?php printf(esc_html__('Search Result', 'skincare-shop')); ?></h1>
                                <?php get_search_form(); ?>
                                <p class="count"><?php 
                                /* translators: %s: search query */
                                printf(esc_html__('Search Results for "%s"', 'skincare-shop'), '<span>' . get_search_query() . '</span>'); ?></p>
                            </header><!-- .page-header -->
                        ...
                        <div class="row">
                            <?php if (have_posts()) : ?>
                                <header class="page-header">
                                    <h1 class="page-title"><?php printf(esc_html__('Search Result', 'skincare-shop')); ?></h1>
                                    <?php get_search_form(); ?>
                                    <p class="count"><?php printf(esc_html__('Search Results for "%s"', 'skincare-shop'), '<span>' . get_search_query() . '</span>'); ?></p>
                                </header><!-- .page-header -->
