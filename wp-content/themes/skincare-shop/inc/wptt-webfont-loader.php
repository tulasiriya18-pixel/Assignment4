...
if ( ! class_exists( 'Skincare_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Skincare_Shop_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$skincare_shop_contents = wp_remote_retrieve_body( $response );

			return $skincare_shop_contents;
		}
...
if ( ! function_exists( 'skincare_shop_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function skincare_shop_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Skincare_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'skincare_shop_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function skincare_shop_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Skincare_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
